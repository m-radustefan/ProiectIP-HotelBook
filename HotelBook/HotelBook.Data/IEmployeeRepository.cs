...
{
    // Interfata care defineste operatiile de baza pentru gestionarea angajatilor.
    // Asigura un contract pentru toate implementările repository-ului.
    public interface IEmployeeRepository
    {
        // Returneaza toti angajatii existenti in sistem.
        IEnumerable<Employee> GetAll();

        // Adauga un nou angajat in sistem.
        void Add(Employee emp);

        // Elimina un angajat dupa ID.
        void Remove(int id);
    }
}